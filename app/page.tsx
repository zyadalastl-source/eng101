      ...
      <Link key={f.title} href={f.href} className="group">
        <Card className="relative overflow-hidden transition duration-200 group-hover:shadow-md group-hover:-translate-y-0.5">
          ...
          <div className="mt-10 grid gap-4 lg:grid-cols-2">
            <Card>
              <CardContent>
                <SectionTitle title="عن ENG101.com" />
                <div className="space-y-2 text-sm text-meu-gray text-right">
                  <div>• ENG101.com هو مشروع طلابي أطلقه فريق من كلية الهندسة والتصميم، مكوّن من أربعة طلاب يُعرفون باسم “أبطال التايتنز”.
...
يحمل الموقع رسالة علمية مستوحاة من إرث العالم المسلم بديع الزمان أبو العز إسماعيل بن الرزاز الجزري، أحد أعظم رواد الهندسة والابتكار في التاريخ الإسلامي، ليكون رمزًا للإبداع العلمي والتكامل بين المعرفة النظرية والتطبيق العملي.

يهدف ENG101.com إلى أن يكون دليلًا أكاديميًا موثوقًا، وعَونًا حقيقيًا للطلاب في مسيرتهم الجامعية، من خلال تنظيم المحتوى وتقديمه بأسلوب بسيط وحديث يخدم الطالب أولًا.</div>
                </div>
              </CardContent>
            </Card>
